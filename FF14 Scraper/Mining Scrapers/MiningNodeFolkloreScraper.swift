...
class MiningNodeFolkloreScraper {
    ...
    func scrapeMiningNodesWiki() throws {
        ...
        let botanyNodes = try scrapeMiningNodes(url: botanistNodesURL)
        ...
        let outputFile = URL(fileURLWithPath: "/Users/christopherdevito/Desktop/MiningNodesFolklore.json")
